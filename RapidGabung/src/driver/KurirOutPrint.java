...
public class KurirOutPrint implements Printable {
	...
	public int print(Graphics g, PageFormat pf, int page) throws PrinterException {
		...
		for (EntryDataShowVO en : dataPrint) {
			...
			g.drawString(en.getAwbData(), 10, heightLooping + 22);
			g.setFont(new Font("Tahoma", Font.PLAIN, 8));
	...
	public void printConfig(String noKardus, String user) {
		this.user = user;
		dataPrint = KurirOutService.getListForPrintKurirOut(noKardus);
	...
	public static void main(String args[]) {
		...
		print.printConfig("160071-140616-01", "K001");
	}
}