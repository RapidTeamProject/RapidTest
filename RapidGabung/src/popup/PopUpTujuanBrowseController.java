...
public class PopUpTujuanBrowseController<T> implements Initializable {
	@FXML
	TableView lb_header;
	...
	private DataEntryBrowseController dataEntryController;
	...
	public void set(DataEntryBrowseController dataEntryController, String kdTujuan, String awb) {
